        ...
        <div class="row">
            <div class="col-md-9" >
                ...
                <div class="form-group" style="display: none;">
                    ...
                    <div class="radio">
                                    <label>
                                        <input type="radio" name="skills" value="skills" required="require" checked/> skill
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="special_skill" value="Special_skill" required="require" checked/> Special_skill
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="deadline" value="1999-01-01" required="require" checked/> 1999-01-01
                                    </label>
                                </div>
