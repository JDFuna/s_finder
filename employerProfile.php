...
<!--Employer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
            ...
            <div class="panel panel-primary">
			  <div class="panel-heading"> <h4>Valid Information</h4></div>
			  <div class="panel-body"><h5>Valid ID: <img src="asset/img/<?php echo $validID; ?>" alt="" style="width: 350px"> </h5></div>
              <div class="panel-body"><h5>NC Certificate: <img src="asset/img/<?php echo $NC; ?>" alt="" style="width: 350px"> </h5></div>
            </div> 
